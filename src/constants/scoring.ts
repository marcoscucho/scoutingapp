...
export const SHEET_URLS = {
  ...
  // Hoja "Rival 1" — mismo spreadsheet del club, tab gid=11363191
  rivalData: buildSheetUrl(`${CLUB_SHEET_BASE}?gid=11363191&single=true&output=csv`),
  // Hoja "Ultimo partido" — stats Wyscout del partido más reciente de Lanús
  ultimoPartido: buildSheetUrl(`${CLUB_SHEET_BASE}?gid=1188395700&single=true&output=csv`),
...
export const METRIC_ABBREVIATIONS: Record<string, string> = {
  'Duelos ganados, %': '% Duelos gan.',
  'Duelos defensivos ganados, %': '% Duelos def.',
  'Duelos aéreos ganados, %': '% Duelos aér.',
  'Interceptaciones/90': 'Intercepciones/90',
  'Precisión pases largos, %': '% Pases largos',
  'Carreras en progresión/90': 'Progresiones/90',
  'Pases hacia adelante/90': 'Pases adel./90',
  'Precisión pases hacia adelante, %': '% Pases adel.',
  'Pases progresivos exitosos/90': 'Pases prog./90',
  'Pases al tercer tercio/90': 'Pases ú.tercio/90',
  'Pases precisos/90': 'Pases prec./90',
  'Acciones de ataque exitosas/90': 'Acciones at./90',
  'Remates/90': 'Remates/90',
  'xA/90': 'xA/90',
  'Centros precisos/90': 'Centros prec./90',
  'Gambetas completadas/90': 'Gambetas comp./90',
  'Duelos atacantes ganados/90': 'Duelos ofens./90',
  'Toques en el área de penalti/90': 'Toques área/90',
  'Faltas recibidas/90': 'Faltas rec./90',
  'Jugadas claves/90': 'J. clave/90',
  'Ataque en profundidad/90': 'Profundidad/90',
  'Acciones defensivas realizadas/90': 'Acc. def./90',
