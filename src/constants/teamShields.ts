...
const SHIELD_MAP: Record<string, string> = {
  ...
  velezsarsfield:         '/escudos/argentina/velez.png',
  quilmes:                '/escudos/argentina/quilmes.png',
  sanmartin:              '/escudos/argentina/sanmartin.png',
  platensebsas:           '/escudos/argentina/platense.png',
  clubplatense:           '/escudos/argentina/platense.png',
  atleticorafaela:        '/escudos/argentina/rafaela.png',
  rafaela:                '/escudos/argentina/rafaela.png',
  ferro:                  '/escudos/argentina/ferro.png',
  ferrocarrileste:        '/escudos/argentina/ferro.png',
  ...
  ldu:                    '/escudos/ecuador/ligadequito.png',
  lduquito:               '/escudos/ecuador/ligadequito.png',
  ldequito:               '/escudos/ecuador/ligadequito.png',
  universidaddeportivaequito: '/escudos/ecuador/ligadequito.png',
