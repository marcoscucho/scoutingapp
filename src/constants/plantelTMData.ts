...
const TM_DATA: Record<string, TMPlayerData> = {
  ...
  // ─── INCORPORACIONES 2026 ─────────────────────────────────────────────────────
  'Alexis González': {
    nombre_completo: 'Alexis Lautaro González',
    imagen: 'https://img.a.transfermarkt.technology/portrait/big/1299453-1721936326.png',
    representante: null,
    valor_mercado: 0,
    valor_mercado_fmt: '€-',
    fin_contrato: '31/12/2026',
  ...
  'Yoshan Valois': {
    nombre_completo: 'Yoshan Stiven Valois Murillo',
    imagen: 'https://img.a.transfermarkt.technology/portrait/big/1258292-1769673293.png',
    representante: 'DEW SPORT',
    valor_mercado: 900_000,
    valor_mercado_fmt: '€900K',
    fin_contrato: '31/12/2029',
  },
  'L. Romero': {
    nombre_completo: 'Luciano Joaquín Romero',
    imagen: 'https://imagecache.365scores.com/image/upload/f_png,w_64,h_64,c_limit,q_auto:eco,dpr_3,d_Athletes:default.png,r_max,c_thumb,g_face,z_0.65/Athletes/188256',
    representante: 'Vidalagente',
    valor_mercado: 100_000,
    valor_mercado_fmt: '€100K',
    fin_contrato: '31/12/2027',
  },
  'Ó. Ontivero': {
    nombre_completo: 'Octavio Damián Ontivero',
    imagen: 'https://img.a.transfermarkt.technology/portrait/big/1000668-1681413801.jpg',
    representante: null,
    valor_mercado: 200_000,
    valor_mercado_fmt: '€200K',
    fin_contrato: '31/12/2027',
  ...
  'F. Acosta': {
    nombre_completo: 'Fabricio Laureano Acosta',
    imagen: 'https://img.a.transfermarkt.technology/portrait/big/1299455-1721936326.png',
    representante: null,
    valor_mercado: 0,
    valor_mercado_fmt: '€-',
    fin_contrato: '',
  ...
  'R. Loaiza': {
    nombre_completo: 'Raúl Alberto Loaiza Morelos',
    imagen: 'https://img.a.transfermarkt.technology/portrait/big/260898-1721935536.png',
    representante: null,
    valor_mercado: 500_000,
    valor_mercado_fmt: '€500K',
    fin_contrato: '31/12/2026',
  },
  'N. Díaz': {
    nombre_completo: 'Nicolás Díaz',
    imagen: 'https://img.a.transfermarkt.technology/portrait/big/default.jpg',
    representante: null,
    valor_mercado: 0,
    valor_mercado_fmt: '€-',
    fin_contrato: '',
