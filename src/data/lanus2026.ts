...
export const LANUS_2026: MatchData[] = [
  ...
  },
  {
    ...
    golesRecibidos: 0, tirosContra: 10, tirosContraPorteria: 5,
  ...
  {
    id: 14, date: '2026-03-27', rival: 'Argentinos Juniors', isHome: false, competition: 'liga',
    result: 'L', golesAFavor: 1, golesEnContra: 2, duration: 101, formation: '4-4-2',
    xG: 0.61, tiros: 8, tirosPorteria: 1, tirosPorteria_pct: 12.5,
    posesion: 35.63, pases: 350, pasesLogrados: 276, pases_pct: 78.86,
    duelos: 208, duelosGanados: 104, duelos_pct: 50.0,
    ataquesPositionales: 26, ataquesPositionalesRemate: 7, contraataques: 0, contraataquesRemate: 0,
    balonParado: 21, balonParadoRemate: 1, corners: 1, centros: 13, centrosPrecisos: 8, pasesEnProfundidad: 9,
    golesRecibidos: 2, tirosContra: 15, tirosContraPorteria: 7,
    duelosDefensivos: 64, duelosDefensivosGanados: 40, duelosDefensivos_pct: 62.5,
    duelosAereos: 51, duelosAereosGanados: 27, duelosAereos_pct: 52.94,
    interceptaciones: 46, despejes: 12, faltas: 14, amarillas: 2, rojas: 0,
    pasesUltimoTercio: 72, pasesUltimoTercioLogrados: 45, pasesUltimoTercio_pct: 62.5,
    pasesProgresivos: 77, pasesProgresivosLogrados: 61, pasesProgresivos_pct: 79.22,
    ppda: 15.6, intensidadPaso: 18.7,
  },
  {
    id: 15, date: '2026-04-02', rival: 'Platense', isHome: true, competition: 'liga',
    result: 'D', golesAFavor: 0, golesEnContra: 0, duration: 96, formation: '4-2-3-1',
    xG: 1.02, tiros: 12, tirosPorteria: 1, tirosPorteria_pct: 8.33,
    posesion: 58.6, pases: 561, pasesLogrados: 468, pases_pct: 83.42,
    duelos: 173, duelosGanados: 88, duelos_pct: 50.87,
    ataquesPositionales: 46, ataquesPositionalesRemate: 11, contraataques: 0, contraataquesRemate: 0,
    balonParado: 15, balonParadoRemate: 1, corners: 1, centros: 23, centrosPrecisos: 7, pasesEnProfundidad: 6,
    golesRecibidos: 0, tirosContra: 3, tirosContraPorteria: 0,
    duelosDefensivos: 44, duelosDefensivosGanados: 30, duelosDefensivos_pct: 68.18,
    duelosAereos: 32, duelosAereosGanados: 14, duelosAereos_pct: 43.75,
    interceptaciones: 27, despejes: 7, faltas: 5, amarillas: 1, rojas: 0,
    pasesUltimoTercio: 71, pasesUltimoTercioLogrados: 49, pasesUltimoTercio_pct: 69.01,
    pasesProgresivos: 84, pasesProgresivosLogrados: 67, pasesProgresivos_pct: 79.76,
    ppda: 18.44, intensidadPaso: 15.98,
  },
  {
  ...
  {
    id: 18, date: '2026-04-17', rival: 'Always Ready', isHome: true, competition: 'internacional',
    result: 'W', golesAFavor: 1, golesEnContra: 0, duration: 99, formation: '4-4-2',
    xG: 2.59, tiros: 18, tirosPorteria: 7, tirosPorteria_pct: 38.89,
    posesion: 59.7, pases: 531, pasesLogrados: 441, pases_pct: 83.05,
    duelos: 191, duelosGanados: 102, duelos_pct: 53.4,
    ataquesPositionales: 47, ataquesPositionalesRemate: 13, contraataques: 0, contraataquesRemate: 0,
    balonParado: 29, balonParadoRemate: 3, corners: 11, centros: 16, centrosPrecisos: 1, pasesEnProfundidad: 18,
    golesRecibidos: 0, tirosContra: 3, tirosContraPorteria: 0,
    duelosDefensivos: 65, duelosDefensivosGanados: 43, duelosDefensivos_pct: 66.15,
    duelosAereos: 31, duelosAereosGanados: 18, duelosAereos_pct: 58.06,
    interceptaciones: 42, despejes: 16, faltas: 11, amarillas: 1, rojas: 0,
    pasesUltimoTercio: 80, pasesUltimoTercioLogrados: 60, pasesUltimoTercio_pct: 75.0,
    pasesProgresivos: 90, pasesProgresivosLogrados: 77, pasesProgresivos_pct: 85.56,
    ppda: 4.55, intensidadPaso: 19.46,
  },
  {
    id: 19, date: '2026-04-21', rival: 'Gimnasia Mendoza', isHome: false, competition: 'liga',
    result: 'L', golesAFavor: 0, golesEnContra: 1, duration: 97, formation: '4-2-3-1',
    xG: 0.76, tiros: 8, tirosPorteria: 1, tirosPorteria_pct: 12.5,
    posesion: 52.4, pases: 388, pasesLogrados: 315, pases_pct: 81.19,
    duelos: 218, duelosGanados: 105, duelos_pct: 48.17,
    ataquesPositionales: 23, ataquesPositionalesRemate: 5, contraataques: 0, contraataquesRemate: 0,
    balonParado: 25, balonParadoRemate: 3, corners: 1, centros: 11, centrosPrecisos: 2, pasesEnProfundidad: 7,
    golesRecibidos: 1, tirosContra: 17, tirosContraPorteria: 4,
    duelosDefensivos: 57, duelosDefensivosGanados: 31, duelosDefensivos_pct: 54.39,
    duelosAereos: 40, duelosAereosGanados: 21, duelosAereos_pct: 52.5,
    interceptaciones: 40, despejes: 13, faltas: 18, amarillas: 3, rojas: 0,
    pasesUltimoTercio: 55, pasesUltimoTercioLogrados: 37, pasesUltimoTercio_pct: 67.27,
    pasesProgresivos: 83, pasesProgresivosLogrados: 67, pasesProgresivos_pct: 80.72,
    ppda: 6.03, intensidadPaso: 16.41,
  },
  {
    id: 20, date: '2026-04-25', rival: 'Central Córdoba SdE', isHome: true, competition: 'liga',
    result: 'D', golesAFavor: 0, golesEnContra: 0, duration: 95, formation: '4-2-3-1',
    xG: 1.85, tiros: 14, tirosPorteria: 5, tirosPorteria_pct: 35.71,
    posesion: 65.32, pases: 600, pasesLogrados: 517, pases_pct: 86.17,
    duelos: 187, duelosGanados: 87, duelos_pct: 46.52,
    ataquesPositionales: 39, ataquesPositionalesRemate: 8, contraataques: 0, contraataquesRemate: 0,
    balonParado: 25, balonParadoRemate: 4, corners: 5, centros: 18, centrosPrecisos: 6, pasesEnProfundidad: 13,
    golesRecibidos: 0, tirosContra: 8, tirosContraPorteria: 3,
    duelosDefensivos: 53, duelosDefensivosGanados: 31, duelosDefensivos_pct: 58.49,
    duelosAereos: 47, duelosAereosGanados: 21, duelosAereos_pct: 44.68,
    interceptaciones: 36, despejes: 12, faltas: 11, amarillas: 1, rojas: 0,
    pasesUltimoTercio: 79, pasesUltimoTercioLogrados: 60, pasesUltimoTercio_pct: 75.95,
    pasesProgresivos: 91, pasesProgresivosLogrados: 79, pasesProgresivos_pct: 86.81,
    ppda: 7.78, intensidadPaso: 17.24,
  },
  {
    id: 21, date: '2026-04-29', rival: 'LDU Quito', isHome: true, competition: 'internacional',
    result: 'W', golesAFavor: 1, golesEnContra: 0, duration: 101, formation: '4-2-3-1',
    xG: 0.87, tiros: 10, tirosPorteria: 5, tirosPorteria_pct: 50.0,
    posesion: 54.31, pases: 465, pasesLogrados: 373, pases_pct: 80.22,
    duelos: 225, duelosGanados: 115, duelos_pct: 51.11,
    ataquesPositionales: 24, ataquesPositionalesRemate: 5, contraataques: 1, contraataquesRemate: 0,
    balonParado: 26, balonParadoRemate: 4, corners: 6, centros: 12, centrosPrecisos: 4, pasesEnProfundidad: 6,
    golesRecibidos: 0, tirosContra: 7, tirosContraPorteria: 1,
    duelosDefensivos: 71, duelosDefensivosGanados: 50, duelosDefensivos_pct: 70.42,
    duelosAereos: 48, duelosAereosGanados: 25, duelosAereos_pct: 52.08,
    interceptaciones: 45, despejes: 10, faltas: 9, amarillas: 3, rojas: 0,
    pasesUltimoTercio: 65, pasesUltimoTercioLogrados: 43, pasesUltimoTercio_pct: 66.15,
    pasesProgresivos: 99, pasesProgresivosLogrados: 72, pasesProgresivos_pct: 72.73,
    ppda: 9.45, intensidadPaso: 16.73,
  },
  {
    id: 22, date: '2026-05-02', rival: 'Deportivo Riestra', isHome: true, competition: 'liga',
    result: 'D', golesAFavor: 0, golesEnContra: 0, duration: 95, formation: '4-4-2',
    xG: 1.1, tiros: 11, tirosPorteria: 7, tirosPorteria_pct: 63.64,
    posesion: 68.13, pases: 577, pasesLogrados: 469, pases_pct: 81.28,
    duelos: 261, duelosGanados: 133, duelos_pct: 50.96,
    ataquesPositionales: 33, ataquesPositionalesRemate: 7, contraataques: 0, contraataquesRemate: 0,
    balonParado: 30, balonParadoRemate: 4, corners: 4, centros: 14, centrosPrecisos: 4, pasesEnProfundidad: 9,
    golesRecibidos: 0, tirosContra: 4, tirosContraPorteria: 2,
    duelosDefensivos: 67, duelosDefensivosGanados: 47, duelosDefensivos_pct: 70.15,
    duelosAereos: 35, duelosAereosGanados: 19, duelosAereos_pct: 54.29,
    interceptaciones: 47, despejes: 18, faltas: 13, amarillas: 2, rojas: 0,
    pasesUltimoTercio: 82, pasesUltimoTercioLogrados: 61, pasesUltimoTercio_pct: 74.39,
    pasesProgresivos: 112, pasesProgresivosLogrados: 67, pasesProgresivos_pct: 59.82,
    ppda: 5.36, intensidadPaso: 17.17,
  },
  {
    id: 23, date: '2026-05-06', rival: 'Always Ready', isHome: false, competition: 'internacional',
    result: 'L', golesAFavor: 0, golesEnContra: 4, duration: 96, formation: '4-4-2',
    xG: 0.33, tiros: 8, tirosPorteria: 4, tirosPorteria_pct: 50,
    posesion: 35.48, pases: 243, pasesLogrados: 175, pases_pct: 72.02,
    duelos: 124, duelosGanados: 59, duelos_pct: 47.58,
    ataquesPositionales: 16, ataquesPositionalesRemate: 4, contraataques: 0, contraataquesRemate: 0,
    balonParado: 32, balonParadoRemate: 2, corners: 5, centros: 9, centrosPrecisos: 3, pasesEnProfundidad: 2,
    golesRecibidos: 4, tirosContra: 23, tirosContraPorteria: 10,
    duelosDefensivos: 48, duelosDefensivosGanados: 33, duelosDefensivos_pct: 68.75,
    duelosAereos: 20, duelosAereosGanados: 3, duelosAereos_pct: 15,
    interceptaciones: 20, despejes: 10, faltas: 6, amarillas: 1, rojas: 0,
    pasesUltimoTercio: 31, pasesUltimoTercioLogrados: 18, pasesUltimoTercio_pct: 58.06,
    pasesProgresivos: 54, pasesProgresivosLogrados: 28, pasesProgresivos_pct: 51.85,
    ppda: 23.5, intensidadPaso: 16.33,
  },
  {
    id: 24, date: '2026-05-10', rival: 'Argentinos Juniors', isHome: false, competition: 'liga',
    result: 'L', golesAFavor: 0, golesEnContra: 2, duration: 99, formation: '4-2-3-1',
    xG: 0.52, tiros: 7, tirosPorteria: 3, tirosPorteria_pct: 42.86,
    posesion: 48.73, pases: 428, pasesLogrados: 328, pases_pct: 76.64,
    duelos: 225, duelosGanados: 114, duelos_pct: 50.67,
    ataquesPositionales: 21, ataquesPositionalesRemate: 6, contraataques: 0, contraataquesRemate: 0,
    balonParado: 23, balonParadoRemate: 1, corners: 2, centros: 14, centrosPrecisos: 4, pasesEnProfundidad: 9,
    golesRecibidos: 2, tirosContra: 16, tirosContraPorteria: 9,
    duelosDefensivos: 83, duelosDefensivosGanados: 49, duelosDefensivos_pct: 59.04,
    duelosAereos: 35, duelosAereosGanados: 20, duelosAereos_pct: 57.14,
    interceptaciones: 36, despejes: 10, faltas: 16, amarillas: 4, rojas: 0,
    pasesUltimoTercio: 60, pasesUltimoTercioLogrados: 40, pasesUltimoTercio_pct: 66.67,
    pasesProgresivos: 88, pasesProgresivosLogrados: 56, pasesProgresivos_pct: 63.64,
    ppda: 9.52, intensidadPaso: 16.44,
  },
  {
    id: 25, date: '2026-05-21', rival: 'LDU Quito', isHome: false, competition: 'internacional',
    result: 'L', golesAFavor: 0, golesEnContra: 2, duration: 98, formation: '4-2-3-1',
    xG: 0.28, tiros: 4, tirosPorteria: 0, tirosPorteria_pct: 0,
    posesion: 37.92, pases: 278, pasesLogrados: 212, pases_pct: 76.26,
    duelos: 161, duelosGanados: 86, duelos_pct: 53.42,
    ataquesPositionales: 18, ataquesPositionalesRemate: 2, contraataques: 0, contraataquesRemate: 0,
    balonParado: 31, balonParadoRemate: 2, corners: 1, centros: 13, centrosPrecisos: 3, pasesEnProfundidad: 2,
    golesRecibidos: 2, tirosContra: 17, tirosContraPorteria: 4,
    duelosDefensivos: 47, duelosDefensivosGanados: 28, duelosDefensivos_pct: 59.57,
    duelosAereos: 40, duelosAereosGanados: 22, duelosAereos_pct: 55,
    interceptaciones: 37, despejes: 23, faltas: 7, amarillas: 3, rojas: 0,
    pasesUltimoTercio: 46, pasesUltimoTercioLogrados: 25, pasesUltimoTercio_pct: 54.35,
